...
public class ProfielActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // State voor vrienden. Kan ook in verStuurd(Verzoek Verstuurd), verOntvangen(verzoek Ontvangen)
        // , of vrienden
        ...
        vriendenRef.child(huidigeGebUid).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    // Tel aantal vrienden aan de hand van de childs te tellen
